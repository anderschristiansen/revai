...
import { parseArticles } from '../lib/article-parser.js';
...
if (embaseResults.length > 0) {
  ...
  console.log(`Title: ${embaseResults[0].title.substring(0, 100)}...`);
  console.log(`Abstract: ${embaseResults[0].abstract.substring(0, 100)}...`);
}
...
if (webOfScienceResults.length > 0) {
  console.log('First article:');
  console.log(`Title: ${webOfScienceResults[0].title.substring(0, 100)}...`);
  console.log(`Abstract: ${webOfScienceResults[0].abstract.substring(0, 100)}...`);
}
...
if (pubmedResults.length > 0) {
  console.log('First article:');
  console.log(`Title: ${pubmedResults[0].title.substring(0, 100)}...`);
  console.log(`Abstract: ${pubmedResults[0].abstract.substring(0, 100)}...`);
}
